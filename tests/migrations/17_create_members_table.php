...
class CreateMembersTable extends AbstractMigration
{
    ...
    public function up()
    {
        $table = $this->table('members', ['id' => 'member_id']);
        ...
        $table->addColumn('signature', 'text', ['null' => true]);
        $table->addColumn('avatar_filename', 'string', ['limit' => 120, 'null' => true]);
        $table->addColumn('avatar_width', 'integer', ['signed' => false, 'null' => true]);
        $table->addColumn('avatar_height', 'integer', ['signed' => false, 'null' => true]);
        $table->addColumn('photo_filename', 'string', ['limit' => 120, 'null' => true]);
        $table->addColumn('photo_width', 'integer', ['signed' => false, 'null' => true]);
        $table->addColumn('photo_height', 'integer', ['signed' => false, 'null' => true]);
        $table->addColumn('sig_img_filename', 'string', ['limit' => 120, 'null' => true]);
        $table->addColumn('sig_img_width', 'integer', ['signed' => false, 'null' => true]);
        $table->addColumn('sig_img_height', 'integer', ['signed' => false, 'null' => true]);
        $table->addColumn('ignore_list', 'text', ['null' => true]);
        $table->addColumn('private_messages', 'integer', ['signed' => false]);
        ...
        $table->addColumn('join_date', 'integer', ['signed' => false]);
        $table->addColumn('last_visit', 'integer', ['signed' => false]);
        $table->addColumn('last_activity', 'integer', ['signed' => false]);
        $table->addColumn('total_entries', 'integer', ['signed' => false]);
        $table->addColumn('total_comments', 'integer', ['signed' => false]);
        ...
        $table->addColumn('last_forum_post_date', 'integer', ['signed' => false]);
        $table->addColumn('last_email_date', 'integer', ['signed' => false]);
        ...
        $table->addColumn('tracker', 'text', ['null' => true]);
        $table->addColumn('template_size', 'string', ['limit' => 2]);
        $table->addColumn('notepad', 'text', ['null' => true]);
        $table->addColumn('notepad_size', 'string', ['limit' => 2]);
        $table->addColumn('quick_links', 'text', ['null' => true]);
        $table->addColumn('quick_tabs', 'text', ['null' => true]);
