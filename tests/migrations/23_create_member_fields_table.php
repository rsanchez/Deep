...
class CreateMemberFieldsTable extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $table->addColumn('m_field_order', 'integer', ['signed' => false]);
